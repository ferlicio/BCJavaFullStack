...
import { Observable, Subject, Subscriber, filter, map, take, first, last, catchError, of, throwError, retry, timeout } from 'rxjs'
...
/*   filter((conteudo) => {
  ...
  /* catchError((erro) => {
    console.log(chalk.italic(chalk.red('OCORREU UM ERRO NO OBSERVABLE')))
    //return of([erro])
